...
class Configuration:
    ...
    model: str = 'eva02_large_patch14_448.mim_m38m_ft_in22k_in1k'
    ...
    # checkpoints: str = "/home/data1/zgp/mmsport/2022-winners-player-reidentification-challenge-master/model/ViT-L-14_openai/fold-1_seed_1/weights_e4.pth"
    checkpoints: str = "/home/data1/zgp/mmsport/2022-winners-player-reidentification-challenge-master/model/eva02_large_patch14_448.mim_m38m_ft_in22k_in1k_colorjitter/all_data_seed_1/weights_e3.pth"
...
for checkpoint in checkpoints: 
    ...
    with open('/home/data1/zgp/mmsport/2022-winners-player-reidentification-challenge-master/fea/test_vit_l_openai_colorjitetr_refea_dba5_qe12/features_test_dict.pkl', 'rb') as file:
        features_dict = pickle.load(file)
    # with open('/home/data1/zgp/mmsport/2022-winners-player-reidentification-challenge-master/fea/vit_l_openai_colorjiter_fea/features_test_dict.pkl', 'wb') as file:
    ...
    #                         normalize_features=config.normalize_features,
    #                         verbose=config.verbose)
    with open('/home/data1/zgp/mmsport/2022-winners-player-reidentification-challenge-master/fea/test_vit_l_openai_colorjitetr_refea_dba5_qe12/features_challenge_dict.pkl', 'rb') as file:
        features_dict = pickle.load(file)
    # with open('/home/data1/zgp/mmsport/2022-winners-player-reidentification-challenge-master/fea/vit_l_openai_colorjiter_fea/features_challenge_dict.pkl', 'wb') as file:
    #     pickle.dump(features_dict, file)
    # compute distance matrix
